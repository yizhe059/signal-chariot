...
// module(board) -> equipment(battlefield): directly generated by module
    //equipment -> weapon -> 能量类/装填类
    //          -> shield
    //          -> ...
// equipment(battlefield) -> bullet(battlefield): equipement generate bullet